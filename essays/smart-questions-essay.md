...
layout: essay
type: essay
title: 'No such thing as "dumb" questions... except, there is'
...
<img width="300px" class="rounded float-start pe-4" src="../img/smart-questions/stupidquestion.png">

## I have to be smart about _how_ to ask a question?
...
## But dumb questions get answers too... sometimes
...
(Full context of the post in question can be seen [here](https://stackoverflow.com/questions/79877519/how-do-i-set-up-a-database-in-asp-net-mvc)).

## Being smart about asking smart questions
